...
int main(int argc, char *argv[])
{
    ...
    t = t + (tStep/2);
    double difference = t - analytic;
    printf("NUMERICAL_TIME = %lf/n",t);
    printf("ANALYTICAL_TIME = %lf/n",analytic);
    printf("DIFFERENCE_TIME = %lf/n",difference);
    /*   
